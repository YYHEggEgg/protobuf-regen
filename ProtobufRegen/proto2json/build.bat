# 定义变量
WINDOWS_32="go-proto2json_win32.exe"
WINDOWS_64="go-proto2json_win64.exe"
MACOS_32="go-proto2json_mac32"
MACOS_64="go-proto2json_mac64"
LINUX_32="go-proto2json_linux32"
LINUX_64="go-proto2json_linux64"
